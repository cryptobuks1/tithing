              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <form method="post" action="process.php" class="user">
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="user" placeholder="Enter Username...">
                    </div>
                    <div class="form-group">
